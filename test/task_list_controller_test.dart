...
void main() {
  group('TaskListController', () {
    ...
    test('タスクを追加できる', () {
      ...
      expect(controller.tasks[0]['isCompleted'], false);
    });

    test('タスクを更新できる', () {
      controller.addTask('Old Task');
      controller.updateTask(0, 'Updated Task');
      expect(controller.tasks[0]['title'], 'Updated Task');
    });
    ...
    test('タスクを削除できる', () {
      ...
      expect(controller.tasks.length, 1);
      expect(controller.tasks[0]['title'], 'Task 2');
    });
    ...
    test('タスクを並べ替えられる', () {
      ...
      expect(controller.tasks[0]['title'], 'Task 2');
      expect(controller.tasks[1]['title'], 'Task 3');
      expect(controller.tasks[2]['title'], 'Task 1');

      // oldIndex > newIndex
      controller.reorderTasks(2, 0);
      expect(controller.tasks[0]['title'], 'Task 1');
      expect(controller.tasks[1]['title'], 'Task 2');
      expect(controller.tasks[2]['title'], 'Task 3');
    ...
    test('addTask handles edge cases', () {
      ...
      expect(controller.tasks.length, 1);
      expect(controller.tasks[0]['title'], longTitle);
    });
    ...
    test('reorderTasks handles invalid indices', () {
      ...
      expect(controller.tasks[0]['title'], 'Task 2');
      expect(controller.tasks[1]['title'], 'Task 1');
    });
  });
}